...
class Income(Base):
    ...
    name = Column(VARCHAR(50), comment="股票简称")
    report_date = Column(VARCHAR(10), primary_key=True, comment="报告日期")
...
class Balance(Base):
    ...
    code = Column(VARCHAR(20), primary_key=True, comment="股票代码")
    name = Column(VARCHAR(50), comment="股票简称")
    report_date = Column(VARCHAR(10), primary_key=True, comment="公告日期")
    year = Column(Integer, nullable=True, comment="年份")
    seq = Column(Integer, nullable=True, comment="序号")
...
class Performance(Base):
    ...
    industry = Column(VARCHAR(50), nullable=True, comment="所属行业")
    last_announce_date = Column(VARCHAR(10), nullable=True, comment="最新公告日期")
...
class Dividend(Base):
    ...
    total_shares = Column(BigInteger, nullable=True, comment="总股本")
    plan_announce_date = Column(VARCHAR(10), nullable=True, comment="预案公告日")
    register_date = Column(VARCHAR(10), nullable=True, comment="股权登记日")
    ex_dividend_date = Column(VARCHAR(10), nullable=True, comment="除权除息日")
    plan_status = Column(VARCHAR(20), nullable=True, comment="方案进度")
    last_announce_date = Column(VARCHAR(10), primary_key=True, comment="最新公告日期")
...
class FinancialIndicator(Base):
    ...
    code = Column(VARCHAR(20), primary_key=True, comment="股票代码")
    report_date = Column(VARCHAR(10), primary_key=True, comment="报告日期（如 2024-12-31）")
    year = Column(Integer, nullable=True, comment="年份")
